...
def market_dashboard():
    ...
    <button onclick="loadData('/api/market/1/latest')">USA Latest Day</button>
    ...
    <button onclick="loadData('/api/market/2/latest')">BRVM Latest Day</button>
    ...
    <button onclick="loadData('/api/market/3/latest')">Nigeria Latest Day</button>
